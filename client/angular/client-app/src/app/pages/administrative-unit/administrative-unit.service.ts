...
export class AdministrativeUnitService {
  ...
  private readonly END_POINT = this.configInitService.apiBaseUrl + '/api/v1/hivadminunit';
  ...
  getListChildren(id: string, searchObject: SearchObject): Observable<any> {
  ...
  getAllParent(searchObject: SearchObject): Observable<any> {
